        ...
        <div className="flex items-center justify-between border-b border-panel-border pb-6">
          <div>
            ...
            <p className="mt-2 text-sm text-text-muted">
              Manage your visualization preferences and application settings.
            </p>
          </div>
          <button
            onClick={() => navigate("/")}
          ...
          <div className="bg-panel-bg shadow-sm overflow-hidden sm:rounded-lg border border-panel-border">
            <div className="px-4 py-5 sm:px-6 bg-input-bg border-b border-panel-border">
              ...
              <p className="mt-1 max-w-2xl text-sm text-text-muted">
                Customize how the 3D model is rendered.
              </p>
            </div>
            <div className="px-4 py-5 sm:p-6 space-y-6">
              ...
              <div className="flex items-center justify-between">
                <div className="flex flex-col">
                  ...
                  <span className="text-sm text-text-muted">
                    Display the red wireframe indicating clickable areas on the
                    model.
                  </span>
                </div>
                <button
                ...
                >
                  <span
                    aria-hidden="true"
                    className={`${showWireframe ? "translate-x-5" : "translate-x-0"} pointer-events-none inline-block h-5 w-5 transform rounded-full bg-panel-bg shadow ring-0 transition duration-200 ease-in-out`}
                  ></span>
                </button>
              </div>
            </div>
          ...
          <div className="bg-panel-bg shadow-sm overflow-hidden sm:rounded-lg border border-panel-border">
            ...
            <div className="px-4 py-5 sm:p-6">
              <div className="text-sm text-text-muted flex flex-col gap-2">
                ...
                <p>
                  <strong>Engine:</strong> React Three Fiber (Three.js)
                </p>
                <p className="mt-4">
                  This application visualizes human anatomy with a focus on
                  disease localization. Models are simplified representations.
                </p>
              </div>
            </div>
          </div>
